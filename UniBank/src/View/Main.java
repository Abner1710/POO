    ...
    public static void menu(int opc) {
        ...
        switch (opc) {
            ...
            case 7:
                ...
                if (!banco.getListaCuentas().isEmpty() || !banco.getListaCuentasEsp().isEmpty()) {
                    Cuenta destino;
                    int numero = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el número de cuenta que tranferira dinero:"));
                    Cuenta Nconta = banco.cuentaExiste(numero);
                    if (Nconta != null) {
                        numero = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el número de cuenta que recibira la transferencia:"));
