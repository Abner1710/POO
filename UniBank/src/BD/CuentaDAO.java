    ...
    public static List<Cuenta> cargarCuentas() {
        ...
        try (Connection conn = bd.conectar();
            ...
            while (rs.next()) {
                ...
                cuenta.getAranceles().setPagoMatricula("Pagado".equals(rs.getString("matri")));
                cuenta.getAranceles().setPagoLaboratorio("Pagado".equals(rs.getString("lab")));
                cuenta.getAranceles().setPagoBiblioteca("Pagado".equals(rs.getString("biblio")));
